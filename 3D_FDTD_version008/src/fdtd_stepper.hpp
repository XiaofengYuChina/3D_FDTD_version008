...
inline void fdtd_update_H(
    ...
    const Real* __restrict dy_array,  // Size NyT
    const Real* __restrict dz_array,  // Size NzT
    ...
    Real* __restrict Hx, Real* __restrict Hy, Real* __restrict Hz   )
{
    ...
    const size_t sI = NyT * NzT;        // i stride
    const size_t sJ = NzT;              // j stride
    const size_t sK = 1;                // k stride
